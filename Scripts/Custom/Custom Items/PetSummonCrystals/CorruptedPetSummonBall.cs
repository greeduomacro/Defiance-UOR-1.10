...
{
	public class PetSummonBall : Item
	{
		public int m_Charges;

		[Constructable]
		public PetSummonBall() : base(0xE2E)
		{
			Weight = 1.0;
                        Hue = 2401;
			Movable = true;
			m_Charges = 3;
			Name= "Corrupted Crystal Ball of Pet Summoning";
		}

		public PetSummonBall( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			PetSummonGump.EnsureClosed( from );
			from.SendGump( new PetSummonGump( (PlayerMobile)from, this ) );
		}
