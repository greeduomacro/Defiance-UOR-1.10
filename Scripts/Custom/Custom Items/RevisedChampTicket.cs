...
{
	public class RevisedChampTicket : Item, IConvertableItem
	{
		...
		//[Constructable]
		public RevisedChampTicket() : base( 0x14F0 )
		{
			Weight = 6.0;
		...
		public RevisedChampTicket( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump : Gump
		{
			...
			private RevisedChampTicket m_Ticket;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				switch ( info.ButtonID )
				{
					...
					case 6: item = new EvoSpiderEvoEgg(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
				}
