...
namespace Server.Mobiles
{
	public class CrookedGuard : BaseCreature
	{
		...
		public CrookedGuard( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			if ( e.Mobile.InRange( this.Location, 2 ) )
			{
				...
				{
					Say( String.Format( "Very well "+e.Mobile.Name+"! Lets see what short-term's you need to lose, just don't tell the other guards!" ) );

					e.Mobile.CloseGump( typeof( GuardBribeShort ) );
					e.Mobile.SendGump( new GuardBribeShort( e.Mobile, e.Mobile.Kills, 0, 0 ) );
				}
			}
			base.OnSpeech( e );
		}
