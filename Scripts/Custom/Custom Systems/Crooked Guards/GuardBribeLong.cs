   	...
   	public class GuardBribe : Gump
   	{
        ...
        public int v_Counts;
     	public int v_Bribe;
      	...
      	public GuardBribe( Mobile owner, int v_counts, int v_bribe, int v_lCounts ) : base( 10, 10 )
      	{
			owner.CloseGump( typeof( GuardBribe ) );
		    ...
		    m_Owner = owner;
         	...
         	gumpX = 89; gumpY = 11;
         	AddLabel( gumpX, gumpY, 37, "Long Term Counts" );

         	gumpX = 66; gumpY = 38;
         	AddLabel( gumpX, gumpY, 40, "Long Terms:" );
