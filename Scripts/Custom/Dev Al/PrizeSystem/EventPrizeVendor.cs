...
{
    public class EventPrizeVendor : Mobile
    {
        [Constructable]
        public EventPrizeVendor()
            : base()
        {
            InitBody();
            InitOutfit();
        ...
        public EventPrizeVendor(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            {
                from.CloseGump(typeof(EventPrizeGump));
                from.SendGump(new EventPrizeGump(from));
            }
        }
        private class BuyVendorEntry : ContextMenuEntry
        {
            public BuyVendorEntry(EventPrizeVendor vendor)
                : base(6103)
            {
            }
