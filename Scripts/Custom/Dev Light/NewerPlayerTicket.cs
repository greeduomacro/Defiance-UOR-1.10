...
{
	public class NewerPlayerTicket : Item
	{
		...
		[Constructable]
		public NewerPlayerTicket() : base( 0x14EF )
		{
			Weight = 1.0;
		...
		public NewerPlayerTicket( Serial serial ) : base( serial )
		{
		}
		...
		{
			private NewerPlayerTicket m_Ticket;
