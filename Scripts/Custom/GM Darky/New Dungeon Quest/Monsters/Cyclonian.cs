...
namespace Server.Mobiles
{
	...
	{
		public override string DefaultName{ get{ return "Cyclonian"; } }
		...
		public Cyclonian() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.15, 0.2 )
		{
			...
			AddItem( Immovable( Rehued( new WarHammer(), 2118 ) ) );
			AddItem( Immovable( Rehued( new BoneHelm(), 1359 ) ) );
			AddItem( Immovable( Rehued( new BoneChest(), 1359 ) ) );
			AddItem( Immovable( Rehued( new BoneGloves(), 1359 ) ) );
			AddItem( Immovable( Rehued( new BoneLegs(), 1359 ) ) );
			AddItem( Immovable( Rehued( new BoneArms(), 1359 ) ) );
