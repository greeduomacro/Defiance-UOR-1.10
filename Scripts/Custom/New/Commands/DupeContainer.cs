...
namespace Server.Commands
{
	public class DupeContainer
	{
		...
		{
			CommandSystem.Register( "DupeContainer", AccessLevel.GameMaster, new CommandEventHandler( DupeContainer_OnCommand ) );
			CommandSystem.Register( "DupeBag", AccessLevel.GameMaster, new CommandEventHandler( DupeBag_OnCommand ) );
		}
