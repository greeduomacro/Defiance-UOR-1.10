...
namespace Server.Commands
{
    public class FindRegionControl
    {
        ...
        {
            CommandSystem.Register("FindRegionControl", AccessLevel.GameMaster, new CommandEventHandler(FindRegionControl_OnCommand));
            CommandSystem.Register("FindRC", AccessLevel.GameMaster, new CommandEventHandler(FindRegionControl_OnCommand));
            CommandSystem.Register("PullRegionControl", AccessLevel.Lead, new CommandEventHandler(PullRegionControl_OnCommand));
        }
