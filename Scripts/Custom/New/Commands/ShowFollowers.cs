...
namespace Server.Commands
{
	public class Followers
	{
		...
		{
			CommandSystem.Register("ShowFollowers", AccessLevel.GameMaster, new CommandEventHandler(Followers_OnCommand));
		}
		...
		public static void Followers_OnTarget( Mobile from, object obj )
		{
			...
			PlayerMobile master = obj as PlayerMobile;
	...
	public class Stable
	{
		public static void Initialize()
		{
			CommandSystem.Register("Stable", AccessLevel.GameMaster, new CommandEventHandler(Stable_OnCommand));
		}
