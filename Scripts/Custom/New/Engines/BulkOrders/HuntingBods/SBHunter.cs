	...
	public class SBHunter : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( BoneHelm ), 40, 10, 0x1451, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( BoneArms ), 40 );
				Add( typeof( BoneChest ), 52 );
				Add( typeof( BoneGloves ), 30 );
				Add( typeof( BoneHelm ), 20 );
				Add( typeof( BoneLegs ), 40 );

				Add( typeof( LeatherArms ), 35 );
				Add( typeof( LeatherChest ), 52 );
				Add( typeof( LeatherGloves ), 24 );
				Add( typeof( LeatherGorget ), 28 );
