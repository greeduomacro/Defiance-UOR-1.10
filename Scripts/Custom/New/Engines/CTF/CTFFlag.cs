...
namespace Server.Items
{
	...
	public class CTFFlag : Item, IGameFlag
	{
        ...
        public void RandomizeItemID()
        {
            //this.ItemID = (Utility.RandomList(0x1587, 0x158A, 0x158D, 0x1591, 0x1593, 0x1595, 0x161E, 0x1621, 0x1624, 0x1627, 0x1629, 0x162C));
        }
				...
				else if ( target is CTFFlag )
				{
					...
					if ( flag.Team == fteam )
					{
						if ( flag.Home )
						{
							...
							if (m_Flag.Game != null && m_Flag.Game.IsLeagueGame) CTFLScoreBoard.Captured(from);
