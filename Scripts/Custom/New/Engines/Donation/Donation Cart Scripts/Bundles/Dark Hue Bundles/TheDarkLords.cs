...
namespace Server.Items
{
	...
	public class TheDarkLords : MetalBox
	{
		[Constructable]
		public TheDarkLords()
		{
			...
			Hue = 2054;
			Item item = null;
			Name = "Defiance Dark Lord Member Box";
			...
			item.Hue = 2054;
			item.Name = "The Dark Lord Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 2054;
			cont.Name = "a dark lord backpack";
			...
			item.Hue = 2054;
			item.Name = "The Dark Lord Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(2054);
			PlaceItemIn( 103, 58, (item = new Sandals()) );
			item.Hue = Utility.RandomList(2054);
                        item.Name = "Dark Lord Sandals";
			item.LootType = LootType.Blessed;
		...
		public TheDarkLords( Serial serial ) : base( serial )
		{
		}
