...
namespace Server.Items
{
	...
	public class TheDarkSoldiers : MetalBox
	{
		[Constructable]
		public TheDarkSoldiers()
		{
			Weight = 1.0;
			Hue = 2053;
			Item item = null;
			Name = "Defiance Dark Soldiers Member Box";
			...
			item.Hue = 2053;
			item.Name = "The Dark Soldiers Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 2053;
			cont.Name = "a dark Dark Soldiers backpack";
			...
			item.Hue = 2053;
			item.Name = "The Dark Soldiers Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(2053);
			PlaceItemIn( 103, 58, (item = new Sandals()) );
			item.Hue = Utility.RandomList(2053);
                        item.Name = "Dark Soldiers Polar Sandals";
			item.LootType = LootType.Blessed;
		...
		public TheDarkSoldiers( Serial serial ) : base( serial )
		{
		}
