...
namespace Server.Items
{
	...
	public class FireDonationBox : MetalBox
	{
		[Constructable]
		public FireDonationBox()
		{
			Weight = 1.0;
			Hue = 1359;
			Item item = null;
			Name = "Defiance Fire Member Box";
			...
			item.Hue = 1359;
			item.Name = "Fire Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1359;
			cont.Name = "a fire backpack";
			...
			item.Hue = 1359;
			item.Name = "Fire Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1359);
		...
		public FireDonationBox( Serial serial ) : base( serial )
		{
		}
