...
namespace Server.Items
{
	...
	public class OrangeDonationBox : MetalBox
	{
		[Constructable]
		public OrangeDonationBox()
		{
			Weight = 1.0;
			Hue = 1259;
			Item item = null;
			Name = "Defiance Orange Member Box";
			...
			item.Hue = 1259;
			item.Name = "Orange Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1259;
			cont.Name = "a orange backpack";
			...
			item.Hue = 1259;
			item.Name = "Orange Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1259);
		...
		public OrangeDonationBox( Serial serial ) : base( serial )
		{
		}
