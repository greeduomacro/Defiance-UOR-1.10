...
namespace Server.Items
{
	...
	public class PoisongreenDonationBox : MetalBox
	{
		[Constructable]
		public PoisongreenDonationBox()
		{
			Weight = 1.0;
			Hue = 1196;
			Item item = null;
			Name = "Defiance Poison Green Member Box";
			...
			item.Hue = 1196;
			item.Name = "Poison Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1196;
			cont.Name = "a poison green backpack";
			...
			item.Hue = 1196;
			item.Name = "Poison Green Ancient Coat";
                        item.LootType = LootType.Blessed;
		...
		public PoisongreenDonationBox( Serial serial ) : base( serial )
		{
		}
