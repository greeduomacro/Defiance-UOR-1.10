...
namespace Server.Items
{
	...
	public class SkyBlueDonationBundle : MetalBox
	{
		[Constructable]
		public SkyBlueDonationBundle()
		{
			Weight = 1.0;
			Hue = 1173;
			Item item = null;
			Name = "Defiance Sky Blue Member Box";
			...
			item.Hue = 1173;
			item.Name = "Defiance Sky Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1173;
			cont.Name = "a Sky blue backpack";
			...
			item.Hue = 1173;
			item.Name = "Sky Blue Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1173);
			PlaceItemIn( 103, 58, (item = new Sandals()) );
			item.Hue = Utility.RandomList(1173);
                        item.Name = "Sky Sandals";
			item.LootType = LootType.Blessed;
		...
		public SkyBlueDonationBundle( Serial serial ) : base( serial )
		{
		}
