...
namespace Server.Items
{
	...
	public class VelvetPurpleDonationBox : MetalBox
	{
		[Constructable]
		public VelvetPurpleDonationBox()
		{
			Weight = 1.0;
			Hue = 1374;
			Item item = null;
			Name = "Defiance Velvet Purple Member Box";
			...
			item.Hue = 1374;
			item.Name = "Velvet Purple Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1374;
			cont.Name = "a velvet purple backpack";
			...
			item.Hue = 1374;
			item.Name = "Velvet Purple Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1374);
		...
		public VelvetPurpleDonationBox( Serial serial ) : base( serial )
		{
		}
