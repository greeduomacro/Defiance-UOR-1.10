...
namespace Server.Items
{
	...
	public class GoldenDonationBox : MetalBox
	{
		[Constructable]
		public GoldenDonationBox()
		{
			Weight = 1.0;
			Hue = 2213;
			Item item = null;
			Name = "Defiance Gold Member Box";
		...
		public GoldenDonationBox( Serial serial ) : base( serial )
		{
		}
