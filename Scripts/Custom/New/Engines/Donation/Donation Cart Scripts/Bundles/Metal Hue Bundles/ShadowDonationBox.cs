...
namespace Server.Items
{
	...
	public class ShadowDonationBox : MetalBox
	{
		[Constructable]
		public ShadowDonationBox()
		{
			Weight = 1.0;
			Hue = 2406;
			Item item = null;
			Name = "Defiance Shadow Member Box";
			...
			item.Hue = 2406;
			item.Name = "Dark Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 2406;
			cont.Name = "a shadow backpack";
		...
		public ShadowDonationBox( Serial serial ) : base( serial )
		{
		}
