...
namespace Server.Items
{
	...
	public class SilverDonationBox : MetalBox
	{
		[Constructable]
		public SilverDonationBox()
		{
			Weight = 1.0;
			Hue = 2401;
			Item item = null;
			Name = "Defiance Silver Member Box";
		...
		public SilverDonationBox( Serial serial ) : base( serial )
		{
		}
