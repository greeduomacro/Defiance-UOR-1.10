...
namespace Server.Items
{
	...
	public class ValoriteDonationBox : MetalBox
	{
		[Constructable]
		public ValoriteDonationBox()
		{
			Weight = 1.0;
			Hue = 2119;
			Item item = null;
			Name = "Defiance Valorite Member Box";
			...
			item.Hue = 2119;
			item.Name = "Valorite Ancient Coat";
                        item.LootType = LootType.Blessed;
		...
		public ValoriteDonationBox( Serial serial ) : base( serial )
		{
		}
