...
namespace Server.Items
{
	...
	public class OliveDonationBox : MetalBox
	{
		[Constructable]
		public OliveDonationBox()
		{
			Weight = 1.0;
			Hue = 1445;
			Item item = null;
			Name = "Defiance Olive Member Box";
			...
			item.Hue = 1445;
			item.Name = "Olive Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1445;
			cont.Name = "a olive backpack";
			...
			item.Hue = 1445;
			item.Name = "Olive Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1445);
		...
		public OliveDonationBox( Serial serial ) : base( serial )
		{
		}
