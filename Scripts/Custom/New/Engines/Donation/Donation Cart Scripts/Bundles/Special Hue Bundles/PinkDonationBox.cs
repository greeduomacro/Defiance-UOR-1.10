...
namespace Server.Items
{
	...
	public class PinkDonationBox : MetalBox
	{
		[Constructable]
		public PinkDonationBox()
		{
			Weight = 1.0;
			Hue = 1203;
			Item item = null;
			Name = "Defiance Pink Member Box";
			...
			item.Hue = 1203;
			item.Name = "Pink Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1203;
			cont.Name = "a pink backpack";
			...
			item.Hue = 1203;
			item.Name = "Pink Ancient Coat";
                        item.LootType = LootType.Blessed;

		        PlaceItemIn( 74, 64, (item = new WizardGlasses()) );
                        item.Hue = Utility.RandomList(1203);
		...
		public PinkDonationBox( Serial serial ) : base( serial )
		{
		}
