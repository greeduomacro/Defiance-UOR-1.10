...
namespace Server.Items
{
	...
	public class PurpleDonationBox : MetalBox
	{
		[Constructable]
		public PurpleDonationBox()
		{
			Weight = 1.0;
			Hue = 1235;
			Item item = null;
			Name = "Defiance Purple Member Box";
			...
			item.Hue = 1235;
			item.Name = "Purple Shroud of Shadows";
                        item.LootType = LootType.Blessed;

			BaseContainer cont;
			PlaceItemIn( 58, 57, (cont = new Backpack()) );
			cont.Hue = 1235;
			cont.Name = "a purple backpack";
		...
		public PurpleDonationBox( Serial serial ) : base( serial )
		{
		}
