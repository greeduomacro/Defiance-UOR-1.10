...
{
	public class SpecialEtherealMountDeed : Item
	{
		...
		[Constructable]
		public SpecialEtherealMountDeed() : base( 0x14F0 )
		{
			Weight = 6.0;
			LootType = LootType.Blessed;
			Name = "a special ethereal mount deed";
			Hue = 1158;
		}

		public SpecialEtherealMountDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			private SpecialEtherealMountDeed m_Ticket;

			public InternalTarget( SpecialEtherealMountDeed ticket ) : base( 2, false, TargetFlags.None )
			{
				m_Ticket = ticket;
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( targeted is SpecialEtherealMountDeed )
				{
					SpecialEtherealMountDeed theirTicket = targeted as SpecialEtherealMountDeed;
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( Mobile from, SpecialEtherealMountDeed ticket ) : base( 50, 50 )
			{
				m_From = from;
				m_Ticket = ticket;
				...
				AddHtml(80,129,240,24,"A no-age required Ethereal Dragon",true,false);
				//AddLabel( 80, 128, 0x489, "A NoAge Ethereal Dragon" );  //# 1test

				AddButton( 46, 163, 0xFA5, 0xFA7, 2, GumpButtonType.Reply, 0 );
				AddHtml(80,164,240,24,"A no-age required Charger of the Fallen",true,false);
				//AddLabel( 80, 163, 0x489, "A NoAge Ethereal Warsteed" );  //# 1test

				AddButton( 46, 198, 0xFA5, 0xFA7, 3, GumpButtonType.Reply, 0 );
				AddHtml(80,199,240,24,"A no-age required Ethereal Wolf",true,false);
				//AddLabel( 80, 198, 0x489, "A NoAge Ethereal Wolf" );  //# 1test
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				{
					case 1: item = new EtherealDragonSteed(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 2: item = new ChargerOfTheFallen(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
					case 3: item = new EtherealCuSidhe(); /*number = 1049368;*/ break; // You have been rewarded for your dedication to Justice!.
