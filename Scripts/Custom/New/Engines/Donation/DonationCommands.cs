...
namespace Server.Commands
{
	public class DonationCommands
	{
		...
		{
			CommandSystem.Register( "DonationPanel", AccessLevel.Administrator, new CommandEventHandler( DonationPanel_OnCommand ) );
			CommandSystem.Register( "DonatorsOnline", AccessLevel.GameMaster, new CommandEventHandler( DonatorsOnline_OnCommand ) );
			CommandSystem.Register( "DonationStatus", AccessLevel.Player, new CommandEventHandler( DonationStatus_OnCommand ) );
			CommandSystem.Register( "DonationSettings", AccessLevel.Player, new CommandEventHandler( DonationSettings_OnCommand ) );
			//CommandSystem.Register( "ConvertDonationStatuses", AccessLevel.GameMaster, new CommandEventHandler( ConvertDonationStatuses_OnCommand ) );
		}
