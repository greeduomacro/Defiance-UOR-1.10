...
namespace Xanthos.Evo
{
	...
	public abstract class BaseEvoMount : BaseMount, IEvoCreature
	{
		...
		public BaseEvoMount( int bodyID, int itemID, AIType ai, double dActiveSpeed ) : base( bodyID, itemID, ai, FightMode.Closest, 10, 1, dActiveSpeed, 0.4 )
		{
			Init();
		}

		public BaseEvoMount( int bodyID, int itemID ) : base( bodyID, itemID, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Init();
		}
