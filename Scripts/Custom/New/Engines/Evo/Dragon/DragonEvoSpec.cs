...
namespace Xanthos.Evo
{
	...
	public class RaelisDragonStageOne : BaseEvoStage
	{
		public RaelisDragonStageOne()
		{
			...
			BaseSoundID = 0xDB;
			BodyValue = 52; ControlSlots = 2; MinTameSkill = 99.9; VirtualArmor = 40;
	...
	public class RaelisDragonStageTwo : BaseEvoStage
	{
		...
		{
			EvolutionMessage = "has evolved";
			NextEpThreshold = 175000; EpMinDivisor = 20; EpMaxDivisor = 10; DustMultiplier = 20;
			BaseSoundID = 219;
			BodyValue = 89; VirtualArmor = 50;
	...
	public class RaelisDragonStageThree : BaseEvoStage
	{
		public RaelisDragonStageThree()
		{
			...
			NextEpThreshold = 25000000; EpMinDivisor = 30; EpMaxDivisor = 20; DustMultiplier = 20;
			BaseSoundID = 0x5A;
			BodyValue = 0xCE; VirtualArmor = 60;
	...
	public class RaelisDragonStageFour : BaseEvoStage
	{
		public RaelisDragonStageFour()
		{
			...
			BaseSoundID = 362;
			BodyValue = 60; ControlSlots = 3; MinTameSkill = 100.0; VirtualArmor = 70;
	...
	public class RaelisDragonStageFive : BaseEvoStage
	{
		public RaelisDragonStageFive()
		{
			...
			DamageMin = 5; DamageMax = 5; HitsMin= 110; HitsMax = 130;
	...
	public class RaelisDragonStageSix : BaseEvoStage
	{
		public RaelisDragonStageSix()
		{
			...
			BodyValue = 106; VirtualArmor = 170; Hue = 16385;
			...
			DamageMin = 10; DamageMax = 10; HitsMin= 165; HitsMax = 200;
	...
	public class RaelisDragonStageSeven : BaseEvoStage
	{
		public RaelisDragonStageSeven()
		{
			...
			BaseSoundID = 362;
			BodyValue = 46; ControlSlots = 4; VirtualArmor = 255; Hue = 16385;
