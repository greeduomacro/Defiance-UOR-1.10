...
namespace Server.Commands
{
	public class FriendCommands
	{
		...
		{
			CommandSystem.Register( "FriendList", AccessLevel.Player, new CommandEventHandler( FriendList_OnCommand ) );
			CommandSystem.Register( "FTell", AccessLevel.Player, new CommandEventHandler( FTell_OnCommand ) );
		}
