		...
		public override void OnResponse(Server.Network.NetState sender, RelayInfo info)
		{
			switch ( info.ButtonID )
			{
				...
				case 1: // Display player props
                    if (sender.Mobile.AccessLevel < JailSystem.m_JailLevel) return;
				...
				case 2: // Display account admin
                    if (sender.Mobile.AccessLevel < AccessLevel.Administrator) return;
				...
				case 8: // History
                    ...
                    if (sender.Mobile.AccessLevel < JailSystem.m_HistoryLevel) return;
                    m_User.SendGump(new JailViewGump(m_User, m_Jail, m_Callback));
