...
namespace Server.Items
{
	public enum RegionFlag : uint
	{
		...
		DeleteNPCCorpse			= 0x000200000,

		IsDungeonRegion			= 0x000400000,

		//New
		EmptyNPCCorpse			= 0x000800000,
		EmptyPlayerCorpse		= 0x001000000,
	...
	public enum ExtRegionFlag : uint
	{
		None					= 0x00000000,
		AlwaysGrey				= 0x00000001,
		NoMurderCounts			= 0x00000002,
		NoFactionEffects		= 0x00000004,
		NoFameKarma				= 0x00000008,
		CannotTakeRewards		= 0x00000010,
		CastWithoutReagents		= 0x00000020
	}
	...
	public class RegionControl : Item
	{
		...
		private ExtRegionFlag m_ExtFlags;
		...
		public ExtRegionFlag ExtFlags
		{
			get { return m_ExtFlags; }
			set { m_ExtFlags = value; }
		}
		...
		{
			get { return GetFlag(ExtRegionFlag.AlwaysGrey); }
			set { SetFlag(ExtRegionFlag.AlwaysGrey, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool NoMurderCounts
		{
			get { return GetFlag(ExtRegionFlag.NoMurderCounts); }
			set { SetFlag(ExtRegionFlag.NoMurderCounts, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool NoFactionEffects
		{
			get { return GetFlag(ExtRegionFlag.NoFactionEffects); }
			set { SetFlag(ExtRegionFlag.NoFactionEffects, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool NoFameKarma
		{
			get { return GetFlag(ExtRegionFlag.NoFameKarma); }
			set { SetFlag(ExtRegionFlag.NoFameKarma, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool CannotTakeRewards
		{
			get { return GetFlag(ExtRegionFlag.CannotTakeRewards); }
			set { SetFlag(ExtRegionFlag.CannotTakeRewards, value); }
		}

		[CommandProperty(AccessLevel.GameMaster)]
		public bool CastWithoutReagents
		{
			get { return GetFlag(ExtRegionFlag.CastWithoutReagents); }
			set { SetFlag(ExtRegionFlag.CastWithoutReagents, value); }
		}
		...
		public override string DefaultName{ get{ return "Region Controller"; } }
        ...
        public static void OnLogout( LogoutEventArgs e )
        {
            ...
            if ( customRegion != null && customRegion.Controller.LogoutMoveMap != Map.Internal && e.Mobile.AccessLevel == AccessLevel.Player )
				e.Mobile.MoveToWorld( customRegion.Controller.LogoutMoveLocation, customRegion.Controller.LogoutMoveMap );
        }
		...
		public static int GetRegistryNumber(Type t)
		{
			Type[] types = SpellRegistry.Types;
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.WriteEncodedInt((int)m_ExtFlags);
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 8:
				{
					...
					m_Flags = (RegionFlag)reader.ReadEncodedInt();
				...
				case 7:
				{
					CastWithoutReagents = reader.ReadBool();
					goto case 6;
				}
				case 6:
				{
				...
				case 5:
				{
					AlwaysGrey = reader.ReadBool();
					reader.ReadBool();
					goto case 4;
				}
				case 4:
				{
					NoFameKarma = reader.ReadBool();
					/*m_NoPvPPoints =*/ reader.ReadBool();
					NoMurderCounts = reader.ReadBool();
					NoFactionEffects = reader.ReadBool();
					CannotTakeRewards = reader.ReadBool();
					goto case 3;
				}
				case 3:
				{
