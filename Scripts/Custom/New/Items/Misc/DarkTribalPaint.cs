...
{
	public class DarkTribalPaint : Item
	{
		public override int LabelNumber{ get{ return 1040000; } } // savage kin paint

		public override string DefaultName{ get{ return "dark tribal paint"; } }

		[Constructable]
		public DarkTribalPaint() : base( 0x9EC )
		{
			Hue = 1175;
			Weight = 2.0;
		}

		public DarkTribalPaint( Serial serial ) : base( serial )
		{
		}
