...
namespace Server.Accounting {
	public class SyncDB {
		...
		public static void Initialize() {
			...
			CommandSystem.Register("ReloadAccountDB", AccessLevel.Administrator,
									 new CommandEventHandler(ManualSync));

            CommandSystem.Register("SyncDBFull", AccessLevel.Administrator,
                                     new CommandEventHandler(ManualSync));
            CommandSystem.Register("SyncDBDifferential", AccessLevel.Administrator,
        ...
        public static void PullAccount(string username)
        {
			...
			//log.Info(String.Format("pulling account '{0}' from database", username));
