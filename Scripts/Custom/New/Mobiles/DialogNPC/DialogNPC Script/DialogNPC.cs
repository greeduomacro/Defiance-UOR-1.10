	...
	public class DialogNPC : BaseCreature
	{
		...
		private void InitCustomOutfit()
		{
			...
			if ( ! fit.Creature )
			{
				switch ( fit.Hair )
				{
					case "Afro" : HairItemID = 0x2047; break; //AddItem( new Afro( fit.HairHue ) );
					case "Buns" : HairItemID = 0x2046; break; //AddItem( new BunsHair( fit.HairHue ) );
					case "Krisna" : HairItemID = 0x204A; break; //AddItem( new KrisnaHair( fit.HairHue ) );
					case "Long" : HairItemID = 0x203C; break; //AddItem( new LongHair( fit.HairHue ) );
					case "Mohawk" : HairItemID = 0x2044; break; //AddItem( new Mohawk( fit.HairHue ) );
					case "Pageboy" : HairItemID = 0x2045; break; //AddItem( new PageboyHair( fit.HairHue ) );
					case "Pony Tail" : HairItemID = 0x203D; break; //AddItem( new PonyTail( fit.HairHue ) );
					case "Receeding" : HairItemID = 0x2048; break; //AddItem( new ReceedingHair( fit.HairHue ) );
					case "Short" : HairItemID = 0x203B; break; //AddItem( new ShortHair( fit.HairHue ) );
					case "Two Pig Tails" : HairItemID = 0x2049; break; //AddItem( new TwoPigTails( fit.HairHue ) );
				}

				switch( fit.Beard )
				{
					case "Goatee" : FacialHairItemID = 0x2040; break; //AddItem( new Goatee( fit.HairHue ) );
					case "Long" : FacialHairItemID = 0x203E; break; //AddItem( new LongBeard( fit.HairHue ) );
					case "Medium Long" : FacialHairItemID = 0x204C; break; //AddItem( new MediumLongBeard( fit.HairHue ) );
					case "Medium Short" : FacialHairItemID = 0x204B; break; //AddItem( new MediumShortBeard( fit.HairHue ) );
					case "Short" : FacialHairItemID = 0x203f; break; //AddItem( new ShortBeard( fit.HairHue ) );
				}

				FacialHairHue = fit.HairHue;

				if ( fit.Mustache )
				{
					FacialHairItemID = 0x2041; //AddItem( new Mustache( fit.MustacheHue ) );
					FacialHairHue = fit.MustacheHue;
				}
		...
		private void InitDefaultOutfit()
		{
			...
			if ( Female )
			{
				...
				{
					case 0: case 1: AddItem( new ShortPants( GetRandomHue() ) ); break;
					case 2: case 3: case 4: AddItem( new Kilt( GetRandomHue() ) ); break;
			...
			else
			{
				...
				{
					case 0: FacialHairItemID = 0x203E; break; //AddItem( new LongBeard( hairHue ) ); break;
					case 1: FacialHairItemID = 0x204C; break; //AddItem( new MediumLongBeard( hairHue ) ); break;
					case 2: FacialHairItemID = 0x204D; break; //AddItem( new Vandyke( hairHue ) ); break;
					case 3: FacialHairItemID = 0x2041; break; //AddItem( new Mustache( hairHue ) ); break;
					case 4: FacialHairItemID = 0x2040; break; //AddItem( new Goatee( hairHue ) ); break;
				}
			}

			switch ( Utility.Random( Female ? 9 :  8 ) )
			{
				case 0: HairItemID = 0x2047; break; //AddItem( new Afro( hairHue ) ); break;
				case 1: HairItemID = 0x204A; break; //AddItem( new KrisnaHair( hairHue ) ); break;
				case 2: HairItemID = 0x2045; break; //AddItem( new PageboyHair( hairHue ) ); break;
				case 3: HairItemID = 0x203D; break; //AddItem( new PonyTail( hairHue ) ); break;
				case 4: HairItemID = 0x2048; break; //AddItem( new ReceedingHair( hairHue ) ); break;
				case 5: HairItemID = 0x2049; break; //AddItem( new TwoPigTails( hairHue ) ); break;
				case 6: HairItemID = 0x203B; break; //AddItem( new ShortHair( hairHue ) ); break;
				case 7: HairItemID = 0x203C; break; //AddItem( new LongHair( hairHue ) ); break;
				case 8: HairItemID = 0x2046; break; //AddItem( new BunsHair( hairHue ) ); break;
			}
