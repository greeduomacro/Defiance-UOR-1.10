...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		public static int[][] m_ClothHues = new int[][]
			{
				new int[]{ 0x557, 0x488, 0x4F4, 0x48C },
				new int[]{ 0x55D, 0x48B, 0x4FB, 0x492 },
				new int[]{ 0x490, 0x48E, 0x48D, 0x495 },
				new int[]{ 0x455, 0x501, 0x487, 0x494 },
				new int[]{ 0x4F2, 0x4AA, 0x4AC, 0x47E }
			};
		...
		private static Item CreateCloth( int type )
		{
			...
			{
				UncutCloth cloth = new UncutCloth( 10 );
		...
		public static int[] m_SandalHues = new int[]
			{
				0x490, 0x487, 0x4F2,
				0x501, 0x48B, 0x4F4,
				0x4FB, 0x494, 0x495,
