	...
	public class DefCarpentry : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			if ( Core.ML )
			{
				...
				index = AddCraft( typeof( OrnateElvenBoxOSI ),	1044292, 1031763, 80.0, 105.0,	typeof( Log ), 1044041, 25, 1044351 );
				SetNeededExpansion( index, Expansion.ML );
			}
			...
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			index = AddCraft( typeof( LargeWhiteBedEastDeed ), 1044290, "large white bed (east)", 94.7, 113.1, typeof( Log ), 1044041, 150, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
			index = AddCraft( typeof( LargeWhiteBedSouthDeed ), 1044290, "large white bed (south)", 94.7, 113.1, typeof( Log ), 1044041, 150, 1044351 );
			AddSkill( index, SkillName.Tailoring, 75.0, 80.0 );
			AddRes( index, typeof( Cloth ), 1044286, 150, 1044287 );
