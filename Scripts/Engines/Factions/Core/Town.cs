...
namespace Server.Factions
{
	...
	public abstract class Town : IComparable
	{
		...
		{
			if ( !Faction.IsFactionFacet( reg.Map ) )
				return null;
		...
		public bool IsSheriff( Mobile mob )
		{
			...
			return ( mob.AccessLevel >= AccessLevel.Administrator || mob == Sheriff );
		}
		...
		public bool IsFinance( Mobile mob )
		{
			...
			return ( mob.AccessLevel >= AccessLevel.Administrator || mob == Finance );
		}

		public static List<Town> Towns { get { return Reflector.Towns; } }

		public const int SilverCaptureBonus = 2500;
