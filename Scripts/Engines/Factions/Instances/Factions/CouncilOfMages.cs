			...
			Definition =
				new FactionDefinition(
					...
					new RankDefinition[]
					{
						...
						new RankDefinition(  8, 900, 6, new TextDefinition( 1060787, "Spellbinder" ) ),
						new RankDefinition(  7, 800, 6, new TextDefinition( 1060787, "Prophet" ) ),
						new RankDefinition(  6, 700, 5, new TextDefinition( 1060786, "Illusionist" ) ),
						new RankDefinition(  5, 600, 5, new TextDefinition( 1060786, "Luminary" ) ),
						new RankDefinition(  4, 500, 5, new TextDefinition( 1060786, "Diviner" ) ),
						new RankDefinition(  3, 400, 4, new TextDefinition( 1060785, "Conjurer" ) ),
						new RankDefinition(  2, 200, 4, new TextDefinition( 1060785, "Apprentice" ) ),
						new RankDefinition(  1,   0, 4, new TextDefinition( 1060785, "Mystic" ) )
					},
					new GuardDefinition[]
					{
						new GuardDefinition( typeof( FactionHenchman ),		0x1403, 5000, 1000, 5,		new TextDefinition( 1011526, "HENCHMAN" ),		new TextDefinition( 1011510, "Hire Henchman" ) ),
						new GuardDefinition( typeof( FactionMercenary ),	0x0F62, 6000, 2000, 5,		new TextDefinition( 1011527, "MERCENARY" ),		new TextDefinition( 1011511, "Hire Mercenary" ) ),
						new GuardDefinition( typeof( FactionSorceress ),	0x0E89, 7000, 3000, 4,		new TextDefinition( 1011507, "SORCERESS" ),		new TextDefinition( 1011501, "Hire Sorceress" ) ),
						new GuardDefinition( typeof( FactionWizard ),		0x13F8, 8000, 4000, 3,		new TextDefinition( 1011508, "ELDER WIZARD" ),	new TextDefinition( 1011502, "Hire Elder Wizard" ) ),
					}
				);
		}
	}
