			...
			Definition =
				new FactionDefinition(
					...
					new StrongholdDefinition(
						new Rectangle2D[]
						{
							new Rectangle2D( new Point2D( 1555, 1784 ), new Point2D( 1606, 1810 ) )
						},
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionBerserker ),	0x0F4B, 7000, 3000, 4,		new TextDefinition( 1011505, "BERSERKER" ),		new TextDefinition( 1011499, "Hire Berserker" ) ),
						new GuardDefinition( typeof( FactionDragoon ),		0x1439, 8000, 4000, 3,		new TextDefinition( 1011506, "DRAGOON" ),		new TextDefinition( 1011500, "Hire Dragoon" ) ),
					}
				);
		}
	}
