			...
			Definition =
				new FactionDefinition(
					...
					new StrongholdDefinition(
						new Rectangle2D[]
						{
							new Rectangle2D( 1522, 1471, 10, 35 ),
							new Rectangle2D( 1501, 1404, 75, 75 )
						},
						new Point3D( 1520, 1506, 0 ),
						new Point3D( 1524, 1416, 56 ),
						new Point3D[]
						{
							new Point3D( 1526, 1426, 35 ),
							new Point3D( 1529, 1426, 35 ),
							new Point3D( 1532, 1426, 35 ),
							new Point3D( 1535, 1426, 35 ),
							new Point3D( 1535, 1431, 35 ),
							new Point3D( 1532, 1431, 35 ),
							new Point3D( 1529, 1431, 35 ),
							new Point3D( 1526, 1431, 35 )

						} ),
					new RankDefinition[]
					{
						new RankDefinition( 10, 991, 8, new TextDefinition( 1060799, "Purveyor of Darkness" ) ),
						new RankDefinition(  9, 950, 7, new TextDefinition( 1060798, "Ambassador of Death" ) ),
						new RankDefinition(  8, 900, 6, new TextDefinition( 1060797, "Agent of Evil" ) ),
						new RankDefinition(  7, 800, 6, new TextDefinition( 1060797, "Innitiator of Pain" ) ),
						new RankDefinition(  6, 700, 5, new TextDefinition( 1060796, "Bringer of Sorrow" ) ),
						new RankDefinition(  5, 600, 5, new TextDefinition( 1060796, "Death Diciple" ) ),
						new RankDefinition(  4, 500, 5, new TextDefinition( 1060796, "Keeper of Lies" ) ),
						new RankDefinition(  3, 400, 4, new TextDefinition( 1060795, "Haunted Soul" ) ),
						new RankDefinition(  2, 200, 4, new TextDefinition( 1060795, "Minion" ) ),
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionMercenary ),	0x0F62, 1000, 2000, 5,		new TextDefinition( 1011527, "MERCENARY" ),		new TextDefinition( 1011511, "Hire Mercenary" ) ),
						new GuardDefinition( typeof( FactionDeathKnight ),	0x0F45, 3000, 3000, 4,		new TextDefinition( 1011512, "DEATH KNIGHT" ),	new TextDefinition( 1011503, "Hire Death Knight" ) ),
						new GuardDefinition( typeof( FactionNecromancer ),	0x13F8, 4000, 4000, 3,		new TextDefinition( 1011513, "SHADOW MAGE" ),	new TextDefinition( 1011504, "Hire Shadow Mage" ) ),
					}
				);
		}
	}
