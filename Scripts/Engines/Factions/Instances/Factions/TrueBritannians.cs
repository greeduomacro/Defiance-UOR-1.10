			...
			Definition =
				new FactionDefinition(
					...
					new RankDefinition[]
					{
						...
						new RankDefinition(  8, 900, 6, new TextDefinition( 1060792, "Praetorian Vanquisher" ) ),
						new RankDefinition(  7, 800, 6, new TextDefinition( 1060792, "Crusader" ) ),
						new RankDefinition(  6, 700, 5, new TextDefinition( 1060791, "Precept" ) ),
						new RankDefinition(  5, 600, 5, new TextDefinition( 1060791, "Legionaire" ) ),
						new RankDefinition(  4, 500, 5, new TextDefinition( 1060791, "Law Enforcer" ) ),
						new RankDefinition(  3, 400, 4, new TextDefinition( 1060790, "Sentinel" ) ),
						new RankDefinition(  2, 200, 4, new TextDefinition( 1060790, "Samaritan" ) ),
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionKnight ),		0x0F4D, 7000, 3000, 4,		new TextDefinition( 1011528, "KNIGHT" ),		new TextDefinition( 1011497, "Hire Knight" ) ),
						new GuardDefinition( typeof( FactionPaladin ),		0x143F, 8000, 4000, 3,		new TextDefinition( 1011529, "PALADIN" ),		new TextDefinition( 1011498, "Hire Paladin" ) ),
					}
				);
		}
	}
