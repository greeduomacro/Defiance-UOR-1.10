...
namespace Server.Factions
{
	...
	public class FactionWarHorse : BaseMount
	{
		...
		public const int GoldPrice = 5000;
		...
		public FactionWarHorse( Faction faction ) : base( 0xE2, 0x3EA0, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0xA8;
		...
		{
			if ( this.IsDeadPet && this.Controlled && this.ControlMaster == from && from.Alive && ( m_TimeOfDeath + TimeSpan.FromSeconds(10) < DateTime.Now ))
