	...
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			if ( Core.ML )
			{
				...
				{
					new BonusHarvestResource( 0, 99.1, null, null ),	//Nothing
					new BonusHarvestResource( 100, .1, "You have found a diamond!", typeof( Diamond ) ),
					new BonusHarvestResource( 100, .1, "You have found a sapphire!", typeof( Sapphire ) ),
					new BonusHarvestResource( 100, .1, "You have found a citrine!", typeof( Citrine ) ),
					new BonusHarvestResource( 100, .1, "You have found a ruby!", typeof( Ruby ) ),
					new BonusHarvestResource( 100, .1, "You have found an emerald!", typeof( Emerald ) ),
					new BonusHarvestResource( 100, .1, "You have found a tourmaline!", typeof( Tourmaline ) ),
					new BonusHarvestResource( 100, .1, "You have found an amethyst!", typeof( Amethyst ) ),
					new BonusHarvestResource( 100, .1, "You have found a star sapphire!", typeof( StarSapphire ) ),
					new BonusHarvestResource( 100, .1, "You have found a amber!", typeof( Amber ) )
				};
			}
		...
		private static int[] m_MountainAndCaveTiles = new int[]
			{
				...
				0x48E0, 0x48E1, 0x48E2, 0x48E3, 0x48E4, 0x48E5, 0x48E6,
				0x48E7, 0x48E8, 0x48E9, 0x48EA,

				0x47B7, 0x47B8, 0x47B9,

				0x534F, 0x5350, 0x5351, 0x5350, 0x5351, 0x5352, 0x5353,
				0x5354, 0x5355, 0x5356, 0x5357, 0x5358, 0x5359, 0x535A,
				0x535B, 0x535C, 0x535D, 0x535E, 0x535F, 0x5360, 0x5361,
				0x5362, 0x5363, 0x5364, 0x5366, 0x5367, 0x5368, 0x5369,
				0x536A, 0x536B, 0x536C, 0x536D,

				0x5771, 0x5772, 0x5773, 0x5774, 0x5775, 0x5776, 0x5777,
				0x5778, 0x5779, 0x577A, 0x577B, 0x577C,

				0x7341, 0x7342, 0x7343, 0x7344, 0x7345, 0x7346, 0x7347,
				0x7348, 0x7349, 0x734A, 0x734B, 0x734C, 0x734D, 0x734E,
				0x734F, 0x7350, 0x7351,

				0x742A, 0x742B, 0x7431, 0x7432, 0x7433, 0x7434, 0x7435,
				0x7436, 0x7437, 0x7438, 0x7539, 0x753A, 0x753B, 0x753C
			};
