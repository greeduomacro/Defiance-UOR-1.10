...
namespace Server.Engines.MyRunUO
{
	public class Config
	{
		...
		public static string DatabaseDSN			= "PostgreSQL35W";
		...
		//Should the database driver use a DNS? Make sure DatabaseDNS is set properly
		public static bool UseDSN = true;
		...
		{
			if ( UseDSN )
				return String.Format( "DSN={0}", DatabaseDSN );
			else
				return String.Format( "DRIVER={0};SERVER={1};DATABASE={2};UID={3};PASSWORD={4};",
