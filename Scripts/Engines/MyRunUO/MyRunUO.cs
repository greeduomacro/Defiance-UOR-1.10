...
namespace Server.Engines.MyRunUO
{
	public class MyRunUO : Timer
	{
		...
		public void CheckConnection()
		{
			if ( m_Command == null )
			{
				m_Command = new DatabaseCommandQueue( "MyRunUO: Character database updated in {0:F1} seconds", "MyRunUO Character Database Thread" );
		...
		public void InsertMobile( Mobile mob )
		{
			...
			string female = ( mob.Female ? "TRUE" : "FALSE" );

			bool pubBool = ( mob is PlayerMobile ) && ( ((PlayerMobile)mob).PublicMyRunUO );

			string pubString = ( pubBool ? "TRUE" : "FALSE" );
