...
namespace Server.Items
{
	...
	{
		public class LesserPigmentInfo
		{
			private int m_Hue;
			...
			private static LesserPigmentInfo[] m_Table = new LesserPigmentInfo[]
			{
				// Hue, Label
				new LesserPigmentInfo( /*PigmentType.None,*/ 0, -1 ),
				new LesserPigmentInfo( /*PigmentType.PaleOrange,*/ 0x02E, 1071458 ),
				new LesserPigmentInfo( /*PigmentType.FreshRose,*/ 0x4B9, 1071455 ),
				new LesserPigmentInfo( /*PigmentType.ChaosBlue,*/ 0x005, 1071459 ),
				new LesserPigmentInfo( /*PigmentType.Silver,*/ 0x3E9, 1071451 ),
				new LesserPigmentInfo( /*PigmentType.NobleGold,*/ 0x227, 1071457 ),
				new LesserPigmentInfo( /*PigmentType.LightGreen,*/ 0x1C8, 1071454 ),
				new LesserPigmentInfo( /*PigmentType.PaleBlue,*/ 0x24F, 1071456 ),
				new LesserPigmentInfo( /*PigmentType.FreshPlum,*/ 0x145, 1071450 ),
				new LesserPigmentInfo( /*PigmentType.DeepBrown,*/ 0x3F0, 1071452 ),
				new LesserPigmentInfo( /*PigmentType.BurntBrown,*/ 0x41A, 1071453 )
			};

			public static LesserPigmentType GetRandomPigment()
			{
				return GetRandomPigment( false );
			}

			public static LesserPigmentType GetRandomPigment( bool lesser )
			{
				if (lesser)
					return (LesserPigmentType)Utility.Random( m_Table.Length );
				else return (LesserPigmentType)Utility.RandomMinMax(1, m_Table.Length - 1);
			}

			public static LesserPigmentInfo GetInfo( LesserPigmentType type )
			{
				int v = (int)type;
		...
		public LesserPigmentType Type
		{
			...
			set
			{
				...
				LesserPigmentInfo p = LesserPigmentInfo.GetInfo( m_Type );
