...
namespace Server.Gumps
{
	public class CharacterStatueGump : Gump
	{
		...
		private CharacterStatue m_Backup;
		private Timer m_Timer;
		private Mobile m_Owner;

		//public Item Maker{ get{ return m_Maker; } }
		public CharacterStatue Statue{ get{ return m_Statue; } }
		public CharacterStatue Backup{ get{ return m_Backup; } }
		...
		public CharacterStatueGump( CharacterStatue statue, Mobile owner, CharacterStatue backup ) : base( 60, 36 )
		{
			m_Backup = backup;
			m_Statue = statue;
			m_Owner = owner;
			...
			// material
			if ( m_Statue.StatueType <= StatueType.Bronze )
			{
		...
		{
			if ( m_Backup == null )
				m_Owner.Backpack.DropItem( new CharacterStatueMaker( m_Statue.StatueType ) );
			else
				m_Owner.Backpack.DropItem( new CharacterStatueDeed( m_Backup ) );
