			...
			else
			{
				...
				if( idol.Spawn.Active )
				{
					if( idol.Spawn.Champion == null )
					{
						...
						if( idol.Spawn.CanAdvanceByValor )
						{
							...
							from.SendMessage( "The Champion of this region ignores your challenge.  Valor does not interest it." );
					}
					else
						from.SendMessage( "You Champion of this region has already been spawned.  You cannot challenge it further." );
				}
				else
				{
					if( idol.Spawn.CanActivateByValor )
					{
