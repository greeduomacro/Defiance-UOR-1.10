...
namespace Server.Items
{
	...
	public abstract class BaseClothing : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IAosAttributes, IEthicsItem
	{
		#region Ethics
		...
		public override Type DyeType
		{
			get
			{
				...
				else if ( m_Resource >= CraftResource.RegularLeather && m_Resource <= CraftResource.SpinedLeather )
...
//				LabelDyableTo( from );
			...
			if ( Layer == Layer.Earrings || Layer == Layer.Neck )
				LabelTo(from, "[layered]");
		}
