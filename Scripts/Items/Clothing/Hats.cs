...
*/
	[TypeAlias("Server.Items.HornedTribalMask")]
	...
	public class OrcishKinRPMask : BaseHat
	{
		...
		[Constructable]
		public OrcishKinRPMask() : this( 2212 )
		{
		}

		[Constructable]
		public OrcishKinRPMask( int hue ) : base( 0x141B, hue )
		{
			Weight = 1.0;
		...
		public OrcishKinRPMask( Serial serial ) : base( serial )
		{
		}
