...
namespace Server.Items
{
	...
	public class CommodityDeed : Item
	{
		...
		public ICommodity Commodity
		{
			get
			{
				return m_Commodity as ICommodity;
			}
		}
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if ( Commodity != null )
				list.Add( 1060658, "#{0}\t{1}", Commodity.DescriptionNumber, m_Commodity.Amount ); // ~1_val~: ~2_val~
			else
		...
		public override void OnSingleClick( Mobile from )
		{
			...
			if ( Commodity != null )
				from.Send( new UnicodeMessage( Serial, ItemID, MessageType.Label, 0x3B2, 3, from.Language, "", Commodity.Description ) );
		}
