...
{
	public class NewPlayerTicketOSI : Item
	{
		...
		//[Constructable]
		public NewPlayerTicketOSI() : base( 0x14EF )
		{
			Weight = 1.0;
		...
		public NewPlayerTicketOSI( Serial serial ) : base( serial )
		{
		}
		...
		{
			private NewPlayerTicketOSI m_Ticket;
		...
		private class InternalGump : Gump
		{
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( !m_Ticket.IsChildOf( m_From.Backpack ) )
				{
