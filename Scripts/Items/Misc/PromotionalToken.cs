...
{
	public abstract class BasePromotionalToken : Item
	{
		...
		public BasePromotionalToken() : base( 0x2AAA )
		{
		...
		public BasePromotionalToken( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BasePromotionalToken m_Token;

			public PromotionalTokenGump( BasePromotionalToken token ) : base( 10, 10 )
			{
				m_Token = token;
	...
	public class SoulstoneFragmentToken : BasePromotionalToken
	{
		...
		public override string DefaultName{ get{ return "a promotional token for a soulstone fragment"; } }
