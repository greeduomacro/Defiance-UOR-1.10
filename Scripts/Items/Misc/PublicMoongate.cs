...
namespace Server.Items
{
	public class PublicMoongate : Item
	{
		...
		public bool UseGate( Mobile m )
		{
			...
			//else if ( !m_AllowCombat && ( SpellHelper.CheckCombat( m ) || PublicMoongate.CheckCombat( m ) ) )
...
*/
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch( version )
			{
				case 1: m_AllowCombat = reader.ReadBool(); break;
			}
		}
	...
	public class MoongateGump : Gump
	{
		...
		public MoongateGump( Mobile mobile, PublicMoongate moongate ) : base( 100, 100 )
		{
			m_Mobile = mobile;
			m_Moongate = moongate;
...
*/
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			else if ( Factions.Sigil.ExistsOn( m_Mobile ) && !Faction.IsFactionFacet( list.Map ) )
