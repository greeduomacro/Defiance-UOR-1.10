...
{
	public class BaseQuiver : Container, ICraftable, IFactionItem, IEthicsItem
	{
		#region Ethics
		...
		public override int DefaultMaxWeight{ get{ return (int)(m_Capacity * 0.1); } }
		...
		public override bool OnDragDropInto( Mobile from, Item item, Point3D p ) //Automatically stack if possible
		{
