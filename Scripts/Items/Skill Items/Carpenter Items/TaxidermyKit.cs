...
namespace Server.Items
{
	...
	public class TrophyAddon : Item, IAddon
	{
		...
		[Constructable]
		public TrophyAddon( int itemID, int westID, int northID, int deedNumber, int addonNumber, int hue ) : this( itemID, westID, northID, deedNumber, addonNumber, null, 0, hue )
		{
		}

		public TrophyAddon( int itemID, int westID, int northID, int deedNumber, int addonNumber, Mobile hunter, int animalWeight, int hue ) : base( itemID )
		{
			m_WestID = westID;
			m_NorthID = northID;
		...
		public Item Deed
		{
			get{ return new TrophyDeed( m_WestID, m_NorthID, m_DeedNumber, m_AddonNumber, m_Hunter, m_AnimalWeight, Hue ); }
		}
	...
	public class TrophyDeed : Item
	{
		...
		[Constructable]
		public TrophyDeed( int westID, int northID, int deedNumber, int addonNumber, int hue ) : this( westID, northID, deedNumber, addonNumber, null, 0, hue )
		{
		}

		public TrophyDeed( int westID, int northID, int deedNumber, int addonNumber, Mobile hunter, int animalWeight, int hue ) : base( 0x14F0 )
		{
			m_WestID = westID;
			m_NorthID = northID;
			m_DeedNumber = deedNumber;
        ...
        public TrophyDeed( TaxidermyKit.TrophyInfo info, Mobile hunter, int animalWeight, int hue )
            : this( info.NorthID + 7, info.NorthID, info.DeedNumber, info.AddonNumber, hue )
        {
        }
