...
namespace Server.Items
{
	public class PotionKeg : Item
	{
			...
			get
			{
				if ( m_Held > 0 )
				{
					if ( m_Type < PotionEffect.Conflagration )
						...
						return 1072658 + ((int)(m_Type-PotionEffect.ConfusionBlastGreater));
					else
						return 0;
				}
				else
		...
		public override string DefaultName{ get{ return ( ( m_Held <= 0 || m_Type <= PotionEffect.ConfusionBlastGreater ) ? null : GetNameType() ); } }
