...
namespace Server.Items
{
	...
	public class Spellbook : Item, ICraftable, ISlayer, IAosAttributes, IEthicsItem
	{
		...
		public static List<Spellbook> FindAllSpellbooks( Mobile from )
		{
			...
			Spellbook item = from.FindItemOnLayer( Layer.OneHanded ) as Spellbook;
			...
			{
				item = pack.Items[i] as Spellbook;
