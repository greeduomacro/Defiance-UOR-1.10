		...
		public void EndHeal()
		{
			...
			else
			{
				...
				if ( chance > Utility.RandomDouble() )
				{
					...
					if ( healmessage > 0 )
					{
						m_Patient.PrivateOverheadMessage( MessageType.Regular, 0x42, false, healmessage.ToString(), m_Patient.NetState );
						if ( m_Healer != m_Patient )
							m_Patient.PrivateOverheadMessage( MessageType.Regular, 0x42, false, healmessage.ToString(), m_Healer.NetState );
					}
				}
				else
				{
