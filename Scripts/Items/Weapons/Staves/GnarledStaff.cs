...
namespace Server.Items
{
	...
	public class GnarledStaff : BaseStaff
	{
		...
		public void ApplyDelayTo( Mobile from )
		{
			...
			Timer.DelayCall( GetUseDelay, new TimerStateCallback( ReleaseStaffLock_Callback ), from );
		}

		public void ReleaseStaffLock_Callback( object state )
		{
			( (Mobile)state ).EndAction( typeof( GnarledStaff ) );
		}
