...
namespace Server.Guilds
{
	...
	public class Guild : BaseGuild
	{
		public static void Configure()
		{
			...
			CommandSystem.Register( "Guild", AccessLevel.Player, new CommandEventHandler( GuildGump_OnCommand ) );
		}
		...
		[Usage( "Guild" )]
		[Description( "Opens the guild gump." )]
		private static void GuildGump_OnCommand( CommandEventArgs e )
		{
			Mobile from = e.Mobile;
			EventSink_GuildGumpRequest( new GuildGumpRequestArgs( e.Mobile ) );
		}
		...
		public static readonly int RegistrationFee = 50000;
		...
		public static readonly TimeSpan InactiveTime = TimeSpan.FromDays( 60 );
