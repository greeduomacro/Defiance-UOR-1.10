		...
		private static InternationalCode[] InternationalCodes =
			{
				...
				new InternationalCode( "CSY", "Czech", "Czech Republic", "Ceština", "Ceská republika" ),
				...
				new InternationalCode( "ROM", "Romanian", "Romania", "Limba Româna", "România" ),
				...
				new InternationalCode( "SLV", "Slovene", "Slovenia", "Slovenšcina", "Slovenija" ),
				...
				new InternationalCode( "VIT", "Vietnamese", "Viet Nam", "tiê´ng Viê?t", "Vi?t Nam" ),
