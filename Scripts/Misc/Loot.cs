...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_StackFoodTypes = new Type[]
		{
		...
		public static Type[] StackFoodTypes{ get{ return m_StackFoodTypes; } }

		private static Type[] m_ProvisionTypes = new Type[]
		{
			typeof( Arrow ), typeof( Bolt ), typeof( Candle ), typeof( Torch ), typeof( Kindling ),
			typeof( Lantern ), typeof( Bandage ), typeof( Lockpick ), typeof( Bandana ), typeof( Beeswax ),
			typeof( Bottle ), typeof( RedBook ), typeof( BlueBook ), typeof( TanBook ), typeof( Key ),
			typeof( Dices ), typeof( Necklace ), typeof( Beads ), typeof( Knife ), typeof( Spoon ),
			typeof( Fork ), typeof( Hammer ), typeof( Nails ), typeof( BlankScroll ), typeof( Saw ),
			typeof( Shovel ), typeof( Shaft ), typeof( Scissors ), typeof( MortarPestle ), typeof( Tongs ),
			typeof( SewingKit ), typeof( Sextant ), typeof( FishingPole ), typeof( Skillet ), typeof( ShortPants ),
			typeof( LongPants ), typeof( Cloak ), typeof( FloppyHat ), typeof( WideBrimHat ), typeof( Cap ),
			typeof( SkullCap ), typeof( TallStrawHat ), typeof( StrawHat ), typeof( WizardsHat ), typeof( Bonnet ),
			typeof( FeatheredHat ), typeof( TricorneHat ), typeof( JesterHat ), typeof( BodySash ),
			typeof( FullApron ), typeof( Doublet ), typeof( Surcoat ), typeof( Tunic ), typeof( JesterSuit ),
			typeof( Skirt ), typeof( Kilt ), typeof( FancyDress ), typeof( Robe ), typeof( PlainDress ),
			typeof( HalfApron ), typeof( Boots ), typeof( ThighBoots ), typeof( Shoes )
		};

		public static Type[] ProvisionTypes{ get{ return m_ProvisionTypes; } }
		...
		{
			return Construct( m_StackFoodTypes );
		}

		public static Item RandomFood()
		{
			return Construct( m_FoodTypes, m_StackFoodTypes );
		}

		public static Item RandomProvision()
		{
			return Construct( m_ProvisionTypes );
		}
