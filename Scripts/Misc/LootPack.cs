...
/*
		public static readonly LootPackItem[] StatueItems = new LootPackItem[]
			{
				new LootPackItem( typeof( StatueSouth ), 2904 ),
				new LootPackItem( typeof( StatueSouth2 ), 2904 ),
				new LootPackItem( typeof( StatueNorth ), 2904 ),
				new LootPackItem( typeof( StatueWest ), 2904 ),
				new LootPackItem( typeof( StatueEast ), 2904 ),
				new LootPackItem( typeof( StatueEast2 ), 2904 ),
				new LootPackItem( typeof( StatueSouthEast ), 2905 ),
				new LootPackItem( typeof( BustEast ), 2905 ),
				new LootPackItem( typeof( BustSouth ), 2905 ),
				new LootPackItem( typeof( StatuePegasus ), 2905 ),
				new LootPackItem( typeof( StatuePegasus2 ), 2905 ),
				new LootPackItem( typeof( SmallTowerSculpture ), 2901 ),

				new LootPackItem( typeof( WarriorPillarStatueEastDeed ), 12 ), //1/250
				new LootPackItem( typeof( WarriorPillarStatueSouthDeed ), 12 ), //1/250

				new LootPackItem( typeof( CatStatueEastDeed ), 6 ), //1/500
				new LootPackItem( typeof( CatStatueEast2Deed ), 6 ), //1/500
				new LootPackItem( typeof( CatStatueSouthDeed ), 6 ), //1/500
				new LootPackItem( typeof( CatStatueSouth2Deed ), 6 ), //1/500

				new LootPackItem( typeof( ArcanistStatueEastDeed ), 4 ), //1/750
				new LootPackItem( typeof( ArcanistStatueSouthDeed ), 4 ), //1/750
				new LootPackItem( typeof( SquirrelStatueEastDeed ), 4 ), //1/750
				new LootPackItem( typeof( SquirrelStatueSouthDeed ), 4 ), //1/750

				new LootPackItem( typeof( WarriorStatueEastDeed ), 4 ), //1/750
				new LootPackItem( typeof( WarriorStatueSouthDeed ), 4 ), //1/750

				new LootPackItem( typeof( CrystalStatueEastDeed ), 3 ), //1/1000
				new LootPackItem( typeof( CrystalStatueEast2Deed ), 3 ), //1/1000
				new LootPackItem( typeof( CrystalStatueEast3Deed ), 3 ), //1/1000
				new LootPackItem( typeof( CrystalStatueSouthDeed ), 3 ), //1/1000
				new LootPackItem( typeof( CrystalStatueSouth2Deed ), 3 ), //1/1000
				new LootPackItem( typeof( CrystalStatueSouth3Deed ), 3 ), //1/1000

				new LootPackItem( typeof( ShadowStatueEastDeed ), 2 ), //1/1500
				new LootPackItem( typeof( ShadowStatueSouthDeed ), 2 ), //1/1500
			};
*/
		public static readonly LootPackItem[] FoodItems = new LootPackItem[]
			{
				new LootPackItem( typeof( Food ), 1 )
			};

		public static readonly LootPackItem[] MeatItems = new LootPackItem[]
			{
				new LootPackItem( typeof( Ribs ), 1 )
			};

		public static readonly LootPackItem[] FruitsAndVeggieItems = new LootPackItem[]
			{
				new LootPackItem( typeof( Apple ), 1 )
			};

		public static readonly LootPackItem[] GrainsAndHayItems = new LootPackItem[]
			{
				new LootPackItem( typeof( SheafOfHay ), 1 )
			};

		public static readonly LootPackItem[] FishItems = new LootPackItem[]
			{
				new LootPackItem( typeof( RawFishSteak ), 1 )
			};

		public static readonly LootPackItem[] EggItems = new LootPackItem[]
			{
				new LootPackItem( typeof( Eggs ), 1 )
			};

		public static readonly LootPackItem[] ProvisionItems = new LootPackItem[]
			{
		...
		public static readonly LootPackItem[] OldMagicItems = new LootPackItem[]
			{
				new LootPackItem( typeof( BaseJewel ), 4 ),
				new LootPackItem( typeof( BaseArmor ), 16 ),
				new LootPackItem( typeof( BaseWeapon ), 16 ),
				new LootPackItem( typeof( BaseRanged ), 16 ),
...
/*
		public static readonly LootPack CommonStatueDrop = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  false, StatueItems,	75.0, 1 )
			} );

		public static readonly LootPack UncommonStatueDrop = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  false, StatueItems,	10.0, 1 )
			} );

		public static readonly LootPack RareStatueDrop = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  false, StatueItems,	2.00, 1 )
			} );

		public static readonly LootPack VeryRareStatueDrop = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  false, StatueItems,	0.25, 1 )
			} );
*/
		public static readonly LootPack PoorProvisions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(	false, ProvisionItems,	100.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	2 ),
				new LootPackEntry(	false, FoodItems,		100.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	10.0,	1 ),
				new LootPackEntry(	false, FoodItems,		50.0,	2 ),
				new LootPackEntry(	false, FoodItems,		25.0,	2 ),
				new LootPackEntry(	false, FoodItems,		10.0,	2 )
			} );

		public static readonly LootPack MeagerProvisions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(	false, ProvisionItems,	100.0,	6 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	3 ),
				new LootPackEntry(	false, FoodItems,		100.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	2 ),
				new LootPackEntry(	false, ProvisionItems,	10.0,	2 ),
				new LootPackEntry(	false, FoodItems,		50.0,	3 ),
				new LootPackEntry(	false, FoodItems,		25.0,	3 ),
				new LootPackEntry(	false, FoodItems,		10.0,	3 )
			} );

		public static readonly LootPack AverageProvisions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(	false, ProvisionItems,	100.0,	6 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	2 ),
				new LootPackEntry(	false, FoodItems,		100.0,	6 ),
				new LootPackEntry(	false, FoodItems,		75.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	3 ),
				new LootPackEntry(	false, ProvisionItems,	10.0,	2 ),
				new LootPackEntry(	false, FoodItems,		50.0,	5 ),
				new LootPackEntry(	false, FoodItems,		25.0,	5 ),
				new LootPackEntry(	false, FoodItems,		10.0,	5 )
			} );

		public static readonly LootPack RichProvisions = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(	false, ProvisionItems,	100.0,	6 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	5 ),
				new LootPackEntry(	false, ProvisionItems,	75.0,	4 ),
				new LootPackEntry(	false, FoodItems,		100.0,	10 ),
				new LootPackEntry(	false, FoodItems,		75.0,	8 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	50.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	5 ),
				new LootPackEntry(	false, ProvisionItems,	25.0,	4 ),
				new LootPackEntry(	false, ProvisionItems,	10.0,	3 ),
				new LootPackEntry(	false, FoodItems,		50.0,	6 ),
				new LootPackEntry(	false, FoodItems,		25.0,	6 ),
				new LootPackEntry(	false, FoodItems,		10.0,	5 )
			} );
		...
		public static readonly LootPack OldUltraRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 65, 100 )
			} );

		public static readonly LootPack OldSuperBoss = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, "50d10+500" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 30, 100 ),
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 30, 100 ),
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 30, 100 ),
			...
			if ( item != null && !(item is BaseWand) )
			{
				...
				if ( item is BaseWeapon || item is BaseArmor || item is BaseJewel || item is BaseHat )
				{
					...
					{ */
						...
						/*
                        else if ( item is BaseJewel && 10 > Utility.Random( 100 ) )
                        {
                            BaseJewel jewel = (BaseJewel)item;

                            jewel.ChargedAbility = (JewelChargedAbility)( Utility.Random( 3 ) + 1 );
                            jewel.AbilityCharges = Utility.Random( 11 ) + 5;
                        }
						*/
					//}
				}
