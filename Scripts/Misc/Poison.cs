...
*/
				Register( new PoisonImpl( "Lesser",		0, 2, 26,  1.500, 3.0,  2.2,  15, 2 ) );
				Register( new PoisonImpl( "Regular",	1, 5, 26,  3.125, 3.0,  2.2,  15, 2 ) );
				Register( new PoisonImpl( "Greater",	2, 7, 26,  6.250, 3.0,  3.3,  15, 2 ) );
				Register( new PoisonImpl( "Deadly",		3, 6, 26, 12.500, 3.0,  4.4,  15, 2 ) );
				Register( new PoisonImpl( "Lethal",		4, 7, 26, 25.000, 3.0,  8.0,  15, 2 ) );
			}
				Register( new PoisonImpl( "Fatal", 		5, 7, 20, 17.000, 3.0,  1.75, 15, 4 ) );
		}
