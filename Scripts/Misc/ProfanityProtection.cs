...
namespace Server.Misc
{
	...
	public class ProfanityProtection
	{
		...
		private static void EventSink_Speech( SpeechEventArgs e )
		{
			...
			if ( NameVerification.Validate( e.Speech, 0, int.MaxValue, true, true, false, int.MaxValue, m_Exceptions, m_Disallowed, m_StartDisallowed ) != NameResultMessage.Allowed )
