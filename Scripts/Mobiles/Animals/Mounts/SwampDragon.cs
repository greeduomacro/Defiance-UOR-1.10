...
namespace Server.Mobiles
{
	...
	public class SwampDragon : BaseMount
	{
		...
		[Constructable]
		public SwampDragon() : base( 0x31A, 0x3EBD, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x16A;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_HasBarding && m_BardingExceptional && m_BardingCrafter != null )
				list.Add( 1060853, m_BardingCrafter.RawName ); // armor exceptionally crafted by ~1_val~
		}
