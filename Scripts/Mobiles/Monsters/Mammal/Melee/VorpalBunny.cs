...
namespace Server.Mobiles
{
	...
	{
		public override string DefaultName{ get{ return "a vorpal bunny"; } }
		...
		public override void GenerateLoot()
		{
			...
			//AddLoot( LootPack.CommonStatueDrop );
		}
		...
		{
			Timer.DelayCall( TimeSpan.FromMinutes( ( Utility.RandomDouble() * 2.0 ) + 3.0 ), new TimerCallback( BeginTunnel ) );
		}
