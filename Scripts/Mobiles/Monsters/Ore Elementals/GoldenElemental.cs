...
namespace Server.Mobiles
{
	...
	{
		public override string DefaultName{ get{ return "a golden elemental"; } }
		private static readonly int m_DefaultHue = CraftResources.GetInfo( CraftResource.Gold ).Hue;
