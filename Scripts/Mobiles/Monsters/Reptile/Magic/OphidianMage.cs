...
namespace Server.Mobiles
{
	...
	public class OphidianMage : BaseCreature
	{
		...
		public OphidianMage() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			{
				case 0: PackItem( new SkullMugEast1() ); break;
				case 1: PackItem( new SkullMugEast2() ); break;
				case 2: PackItem( new SkullMugSouth1() ); break;
				case 3: PackItem( new SkullMugSouth2() ); break;
			}
