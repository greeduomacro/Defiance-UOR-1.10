...
namespace Server.Mobiles
{
	...
	public class OphidianMatriarch : BaseCreature
	{
		...
		public OphidianMatriarch() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			{
				case 0: PackItem( new DirtyPot1() ); break;
				case 1: PackItem( new DirtyPot2() ); break;
				case 2: PackItem( new DirtyPot3() ); break;
				case 3: PackItem( new DirtyPot4() ); break;
				case 4: PackItem( new DirtyPot5() ); break;
				case 5: PackItem( new DirtyPot6() ); break;
			}
