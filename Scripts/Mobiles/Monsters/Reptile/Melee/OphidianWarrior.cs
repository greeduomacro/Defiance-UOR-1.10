...
namespace Server.Mobiles
{
	...
	public class OphidianWarrior : BaseCreature
	{
		...
		public OphidianWarrior() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			{
				case 0: PackItem( new SilverwareEast() ); break;
				case 1: PackItem( new SilverwareNorth() ); break;
				case 2: PackItem( new SilverwareSouth() ); break;
				case 3: PackItem( new SilverwareWest() ); break;
			}
