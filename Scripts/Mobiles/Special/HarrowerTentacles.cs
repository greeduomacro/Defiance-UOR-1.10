...
namespace Server.Mobiles
{
	...
	public class HarrowerTentacles : BaseCreature
	{
		...
		public override string DefaultName{ get{ return "tentacles of harrower"; } }
		...
		private class DrainTimer : Timer
		{
			...
			private static List<Mobile> m_ToDrain = new List<Mobile>();
			...
			protected override void OnTick()
			{
				...
				{
					if ( m == m_Owner || m == m_Owner.Harrower || !m_Owner.CanBeHarmful( m ) || m.AccessLevel == AccessLevel.Player )
						continue;
