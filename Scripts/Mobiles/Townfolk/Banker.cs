				...
				for ( int i = 0; i < e.Keywords.Length; ++i )
				{
					...
					switch ( keyword )
					{
						case 0x0000: // *withdraw*
						{
							...
							{
								this.Say( "I will not do business with an enemy of our faction!" );
								break;
							}
							...
							if ( split.Length >= 2 )
							{
								...
								else if ( amount > 0 )
								{
									...
									{
										m.AddToBackpack( new Gold( amount ) );
						...
						case 0x0002: // *bank*
						{
							...
							{
								this.Say( "Thou art an enemy of our faction and cannot access thy bank box." );
								break;
							}
