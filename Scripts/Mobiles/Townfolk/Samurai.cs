...
{
	public class SamuraiOSI : BaseCreature
	{
		public override bool CanTeach{ get{ return true; } }
		public override bool ClickTitle{ get{ return false; } }

		[Constructable]
		public SamuraiOSI() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Title = "the samurai";
		...
		public SamuraiOSI( Serial serial ) : base( serial )
		{
		}
