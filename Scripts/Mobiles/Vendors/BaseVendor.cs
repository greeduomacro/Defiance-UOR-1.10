...
*/
		...
		public void UpdateBuyInfo()
		{
			...
			IBuyItemInfo[] buyinfo = m_ArmorBuyInfo.ToArray();
		...
		public BaseVendor( string title )
			: base( AIType.AI_Vendor, FightMode.None, 2, 1, ( Utility.RandomDouble() * 0.1 ) + 0.5, ( Utility.RandomDouble() * 0.2 ) + 2 )
		{
			LoadSBInfo();
		...
		private static int InventoryBuyPackLimit = 2500;
