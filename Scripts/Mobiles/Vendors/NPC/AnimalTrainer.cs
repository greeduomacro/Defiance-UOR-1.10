...
namespace Server.Mobiles
{
	public class AnimalTrainer : BaseVendor
	{
		...
		private bool m_DonatorsOnly;
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DonatorsOnly{ get{ return m_DonatorsOnly; } set{ m_DonatorsOnly = value; } }
		...
		public override void AddCustomContextEntries( Mobile from, List<ContextMenuEntry> list )
		{
			...
			if ( pm != null && from.Alive && ( pm.HasDonated || !m_DonatorsOnly )  )
			{
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (bool)m_DonatorsOnly );
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 1:
				{
					m_DonatorsOnly = reader.ReadBool();
					break;
				}
			}
		}
