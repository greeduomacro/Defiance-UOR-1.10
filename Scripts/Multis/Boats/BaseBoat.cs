...
namespace Server.Multis
{
	...
	public abstract class BaseBoat : BaseMulti
	{
		...
		public static TimeSpan BoatDecayDelay = TimeSpan.FromDays( 9.0 );
		...
		public string StatusText()
		{
			switch ( Status )
			{
				case 1043010: return "This structure is like new.";
				case 1043011: return "This structure is slightly worn.";
				case 1043012: return "This structure is somewhat worn.";
				case 1043013: return "This structure is fairly worn.";
				case 1043014: return "This structure is greatly worn.";
				default:
				case 1043015: return "This structure is in danger of collapsing";
			}
		}
		...
		public static List<BaseBoat> GetBoats( Mobile m )
		{
			List<BaseBoat> list = new List<BaseBoat>();
			List<BaseBoat> exists = new List<BaseBoat>( m_Instances );

			if ( m != null && exists != null )
			{
				for ( int i = 0; i < exists.Count; ++i )
				{
					BaseBoat boat = exists[i];

					if ( boat != null && !boat.Deleted && boat.Owner == m )
						list.Add( boat );
				}
			}
