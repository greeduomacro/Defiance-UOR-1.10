...
namespace Server.Multis
{
	...
	public class HouseFoundation : BaseHouse
	{
        ...
        public override HouseDeed GetDeed() //Al: Enable custom house redeeting
        {
            switch (ItemID)
            {
                case 0x53F1: return new AOSHouseDeed7x12();
                case 0x5428: return new AOSHouseDeed12x7();
                case 0x5451: return new AOSHouseDeed15x12();
                case 0x5430: return new AOSHouseDeed12x15();
                case 0x547b: return new AOSHouseDeed18x18();
                default: return null;
            }
        }
