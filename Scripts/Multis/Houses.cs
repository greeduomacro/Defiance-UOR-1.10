	...
	public class SmallOldHouse : BaseHouse
	{
		...
		public override HouseDeed GetDeed()
		{
			switch ( ItemID ^ 0x4000 )
			{
				...
				case 0x68: if ( !TestCenter.Enabled ) return new SmallBrickHouseDeed(); else return null;
...
/*
			//East Wing
			AddAllBlocker( 10, 5, 0 );
			AddAllBlocker( 10, 4, 0 );
			AddAllBlocker( 10, 3, 0 );
			AddAllBlocker( 10, 2, 0 );
			AddAllBlocker( 10, 1, 0 );
			AddAllBlocker( 10, 0, 0 );
			AddAllBlocker( 10, -1, 0 );
			AddAllBlocker( 10, -2, 0 );
			AddAllBlocker( 10, -3, 0 );
...
/*
		private void AddAllBlocker( int xoff, int yoff, int zoff )
		{
			Item item = new AllBlocker();
			Addons.Add( item );
			item.MoveToWorld( new Point3D( this.X + xoff, this.Y + yoff, this.Z + zoff ), this.Map );
		}
*/
		public override void Serialize( GenericWriter writer )
		{
