...
namespace Server.Items
{
	public class ItemIdentification
	{
		...
		private static readonly string[] m_TreasureValue = new string[]
		{
			"poor", "meager", "average", "somewhat valuable", "valuable", "very valuable", "substantially valuable", "incredibly valuable"
		};
	}
}