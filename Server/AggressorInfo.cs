...
namespace Server
{
	public class AggressorInfo
	{
		...
		private bool m_BeneficialAggression;
		...
		{
			return Create( attacker, defender, criminal, false );
		}

		public static AggressorInfo Create( Mobile attacker, Mobile defender, bool criminal, bool heal )
		{
			AggressorInfo info;
			...
			if ( m_Pool.Count > 0 )
			{
				...
				info.m_BeneficialAggression = heal;
			...
			{
				info = new AggressorInfo( attacker, defender, criminal, heal );
			}
		...
		private AggressorInfo( Mobile attacker, Mobile defender, bool criminal, bool heal )
		{
			m_Attacker = attacker;
			m_Defender = defender;
		...
		public bool BeneficialAggression
		{
			get
			{
				if ( m_Queued )
