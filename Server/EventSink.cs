...
//	public delegate void InscribeMenuRequestEventHandler( InscribeMenuRequestEventArgs e );
	...
	public class AggressiveActionEventArgs : EventArgs
	{
		...
		public bool SendMessage{ get{ return m_SendMessage; } }
		...
		private AggressiveActionEventArgs( Mobile aggressed, Mobile aggressor, bool criminal, bool healing, bool sendMessage )
		{
			m_Aggressed = aggressed;
			m_Aggressor = aggressor;
			m_Criminal = criminal;
			m_SendMessage = sendMessage;
			m_Beneficial = healing;
		}
