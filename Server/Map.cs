...
namespace Server
{
	...
	public class Map : IComparable, IComparable<Map>
	{
		...
		public Map( int mapID, int mapIndex, int fileIndex, int width, int height, int season, string name, MapRules rules ) : this( mapIndex )
		{
			m_MapID = mapID;
			//m_MapIndex = mapIndex;
		...
		{
			m_SectorsWidth = m_Width >> SectorShift;
			m_SectorsHeight = m_Height >> SectorShift;
