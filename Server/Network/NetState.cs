...
namespace Server.Network {
	...
	public class NetState {
		...
		private StringList m_LTable;

		public StringList LTable{ get{ return m_LTable; } set{ m_LTable = value; } }

		private DateTime m_ConnectedOn;

		public DateTime ConnectedOn{ get{ return m_ConnectedOn; } }

		public TimeSpan ConnectedFor{ get{ return ( DateTime.Now - m_ConnectedOn ); } }
