...
namespace Server
{
	public static class Utility
	{
		...
		public static int ToInt32( string value, int defval )
		{
			int i = defval;
		...
		public static long ToInt64( string value, long defval )
		{
			long i = defval;
		...
		public static DateTime ToUtcTime( DateTime time ) //Assume localtime
		{
			return TimeZoneInfo.ConvertTimeToUtc( time );
		}

		public static DateTime ToLocalTime( DateTime time, TimeZoneInfo tzi ) //Assume its UTC
		{
...
#if ( Framework_3_5 || Framework_4_0 )
		private static ReadOnlyCollection<TimeZoneInfo> m_TimeZones = TimeZoneInfo.GetSystemTimeZones();
		public static ReadOnlyCollection<TimeZoneInfo> TimeZones{ get{ return m_TimeZones; } }

		public static TimeZoneInfo GetTimeZone( int index )
		{
			if ( index < 0 || index > m_TimeZones.Count )
				return TimeZoneInfo.Local; //null instead?

			return m_TimeZones[index];
		}
#endif
...
#pragma warning restore 618
		...
		public static int RandomGreyHue()
		{
			return Utility.RandomList( Utility.RandomMinMax(961,1001), Utility.RandomMinMax(1891,1908), Utility.RandomMinMax(2407,2412), Utility.RandomMinMax(2301,2306) );
		}

		public static int RandomBlackHue()
		{
			return Utility.RandomList( 1175, Utility.Random( 2051, 7 ) );
		}
